...
import 'package:levexauto/views/order_recipts/Component/recieptWidget.dart';
import '../../../constants/constants.dart';
import '../../../widgets/widgets.dart';

class RecieptBoxWidget extends StatelessWidget {
  var trackingData;

  RecieptBoxWidget({super.key, required this.trackingData});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                DateFormat.yMMMd().format(trackingData['orderDate'].toDate()),
                style: poppinsMedium.copyWith(
                  color: AppColors.whiteColor,
                  fontSize: kFont14,
                ),
